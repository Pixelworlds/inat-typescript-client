...
export class ObservationTiles {
   ...
   * 
   */
  async colored_heatmap_tiles(zoom: number, x: number, y: number, params?: ColoredHeatmapTilesParams): Promise<ApiResponse<any>> {
    return this.http.get(`/colored_heatmap/${zoom}/${x}/${y}.png`, { params });
  }
   ...
   * 
   */
  async grid_tiles(zoom: number, x: number, y: number, params?: GridTilesParams): Promise<ApiResponse<any>> {
    return this.http.get(`/grid/${zoom}/${x}/${y}.png`, { params });
  }
   ...
   * 
   */
  async heatmap_tiles(zoom: number, x: number, y: number, params?: HeatmapTilesParams): Promise<ApiResponse<any>> {
    return this.http.get(`/heatmap/${zoom}/${x}/${y}.png`, { params });
  }
   ...
   * 
   */
  async points_tiles(zoom: number, x: number, y: number, params?: PointsTilesParams): Promise<ApiResponse<any>> {
    return this.http.get(`/points/${zoom}/${x}/${y}.png`, { params });
  }
}