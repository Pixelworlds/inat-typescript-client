...
export class Places {
   ...
   * 
   */
  async place_details(id: string[], params?: PlaceDetailsParams): Promise<ApiResponse<Types.PlacesResponse>> {
    return this.http.get(`/places/${id}`, { params });
  }
   ...
   * 
   */
  async place_autocomplete(params: PlaceAutocompleteParams): Promise<ApiResponse<Types.PlacesResponse>> {
    return this.http.get(`/places/autocomplete`, { params });
  }
   ...
   * 
   */
  async nearby_places(params: NearbyPlacesParams): Promise<ApiResponse<Types.NearbyPlacesResponse>> {
