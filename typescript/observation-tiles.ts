...
export interface ColoredHeatmapTilesParams {
...
export interface GridTilesParams {
  /** Primary color to use in tile creation. Accepts common colors by string
(e.g. `color=blue`), and accepts escaped color HEX codes
(e.g. `color=%2386a91c`)
 */
...
export interface HeatmapTilesParams {
  /** Primary color to use in tile creation. Accepts common colors by string
(e.g. `color=blue`), and accepts escaped color HEX codes
(e.g. `color=%2386a91c`)
 */
...
export interface PointsTilesParams {
  /** Primary color to use in tile creation. Accepts common colors by string
(e.g. `color=blue`), and accepts escaped color HEX codes
(e.g. `color=%2386a91c`)
 */
...
export class ObservationTiles {
   ...
   * 
   */
  async colored_heatmap_tiles(zoom: number, x: number, y: number, params?: ColoredHeatmapTilesParams): Promise<AxiosResponse<any>> {
    return this.client.get(`/colored_heatmap/${zoom}/${x}/${y}.png`, { params });
  }
   ...
   * 
   */
  async grid_tiles(zoom: number, x: number, y: number, params?: GridTilesParams): Promise<AxiosResponse<any>> {
    return this.client.get(`/grid/${zoom}/${x}/${y}.png`, { params });
  }
   ...
   * 
   */
  async heatmap_tiles(zoom: number, x: number, y: number, params?: HeatmapTilesParams): Promise<AxiosResponse<any>> {
    return this.client.get(`/heatmap/${zoom}/${x}/${y}.png`, { params });
  }
   ...
   * 
   */
  async points_tiles(zoom: number, x: number, y: number, params?: PointsTilesParams): Promise<AxiosResponse<any>> {
    return this.client.get(`/points/${zoom}/${x}/${y}.png`, { params });
  }
}