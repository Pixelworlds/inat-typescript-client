...
export class Messages {
   ...
   */
  async retrieve_messages_for_the_authenticated_user_this_does_not_mark_them_as_read(params?: RetrieveMessagesForTheAuthenticatedUserThisDoesNotMarkThemAsReadParams): Promise<AxiosResponse<any>> {
   ...
   * @requires Authentication
   */
  async create_a_new_message(data: Types.PostMessage): Promise<AxiosResponse<Types.Message>> {
   ...
   * @requires Authentication
   */
  async retrieve_messages_in_a_thread(id: number): Promise<AxiosResponse<any>> {
   ...
   * @requires Authentication
   */
  async delete_a_message_thread(id: number): Promise<AxiosResponse<any>> {
   ...
   * @requires Authentication
   */
  async gets_a_count_of_messages_the_authenticated_user_has_not_read(): Promise<AxiosResponse<any>> {
