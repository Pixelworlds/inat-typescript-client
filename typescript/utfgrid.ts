...
export class UTFGrid {
   ...
   * 
   */
  async colored_heatmap_tiles_utfgrid(zoom: number, x: number, y: number, params?: ColoredHeatmapTilesUtfgridParams): Promise<AxiosResponse<Types.UTFGridResponse>> {
    return this.client.get(`/colored_heatmap/${zoom}/${x}/${y}.grid.json`, { params });
  }
   ...
   * 
   */
  async grid_tiles_utfgrid(zoom: number, x: number, y: number, params?: GridTilesUtfgridParams): Promise<AxiosResponse<Types.UTFGridResponse>> {
    return this.client.get(`/grid/${zoom}/${x}/${y}.grid.json`, { params });
  }
   ...
   * 
   */
  async heatmap_tiles_utfgrid(zoom: number, x: number, y: number, params?: HeatmapTilesUtfgridParams): Promise<AxiosResponse<Types.UTFGridResponse>> {
    return this.client.get(`/heatmap/${zoom}/${x}/${y}.grid.json`, { params });
  }
   ...
   * 
   */
  async points_tiles_utfgrid(zoom: number, x: number, y: number, params?: PointsTilesUtfgridParams): Promise<AxiosResponse<Types.UTFGridResponse>> {
    return this.client.get(`/points/${zoom}/${x}/${y}.grid.json`, { params });
  }
}