...
export class Observations {
   ...
   * 
   */
  async observation_details(id: number[]): Promise<AxiosResponse<Types.ObservationsShowResponse>> {
   ...
   */
  async observation_update(id: number, data: Types.PostObservation): Promise<AxiosResponse<any>> {
   ...
   * @requires Authentication
   */
  async observation_delete(id: number): Promise<AxiosResponse<any>> {
   ...
   * @requires Authentication
   */
  async observations_fave(id: number): Promise<AxiosResponse<any>> {
    return this.client.post(`/observations/${id}/fave`);
  }
   ...
   * @requires Authentication
   */
  async observations_unfave(id: number): Promise<AxiosResponse<any>> {
    return this.client.delete(`/observations/${id}/unfave`);
  }
   ...
   * @requires Authentication
   */
  async observations_review(id: number): Promise<AxiosResponse<any>> {
    return this.client.post(`/observations/${id}/review`);
  }
   ...
   * @requires Authentication
   */
  async observations_unreview(id: number): Promise<AxiosResponse<any>> {
    return this.client.delete(`/observations/${id}/review`);
  }
   ...
   * @requires Authentication
   */
  async observation_subscriptions(id: number): Promise<AxiosResponse<any>> {
    return this.client.get(`/observations/${id}/subscriptions`);
  }
   ...
   * @requires Authentication
   */
  async quality_metric_set(id: number, metric: 'date' | 'location' | 'wild', data: Types.PostQuality): Promise<AxiosResponse<any>> {
   ...
   * 
   */
  async observation_taxon_summary(id: number): Promise<AxiosResponse<any>> {
    return this.client.get(`/observations/${id}/taxon_summary`);
  }
   ...
   * @requires Authentication
   */
  async observation_subscribe(id: number): Promise<AxiosResponse<any>> {
    return this.client.post(`/subscriptions/observation/${id}/subscribe`);
  }
   ...
   * @requires Authentication
   */
  async observation_vote(id: number, data: Types.PostObservationVote): Promise<AxiosResponse<any>> {
    return this.client.post(`/votes/vote/observation/${id}`, data);
  }
   ...
   * @requires Authentication
   */
  async observation_unvote(id: number, data: Types.PostObservationVote): Promise<AxiosResponse<any>> {
    return this.client.delete(`/votes/unvote/observation/${id}`);
  }
   ...
   * 
   */
  async observation_search(params?: ObservationSearchParams): Promise<AxiosResponse<Types.ObservationsResponse>> {
    return this.client.get(`/observations`, { params });
  }
   ...
   * @requires Authentication
   */
  async observation_create(data: Types.PostObservation): Promise<AxiosResponse<any>> {
   ...
   * @requires Authentication
   */
  async observations_deleted(params: ObservationsDeletedParams): Promise<AxiosResponse<any>> {
    return this.client.get(`/observations/deleted`, { params });
  }
   ...
   * 
   */
  async observation_histogram(params?: ObservationHistogramParams): Promise<AxiosResponse<any>> {
    return this.client.get(`/observations/histogram`, { params });
  }
   ...
   * 
   */
  async observation_identifiers(params?: ObservationIdentifiersParams): Promise<AxiosResponse<Types.UserCountsResponse>> {
    return this.client.get(`/observations/identifiers`, { params });
  }
   ...
   * 
   */
  async observation_observers(params?: ObservationObserversParams): Promise<AxiosResponse<Types.ObservationsObserversResponse>> {
    return this.client.get(`/observations/observers`, { params });
  }
   ...
   * 
   */
  async observation_popular_field_values(params?: ObservationPopularFieldValuesParams): Promise<AxiosResponse<any>> {
    return this.client.get(`/observations/popular_field_values`, { params });
  }
   ...
   * 
   */
  async observation_species_counts(params?: ObservationSpeciesCountsParams): Promise<AxiosResponse<Types.SpeciesCountsResponse>> {
    return this.client.get(`/observations/species_counts`, { params });
  }
   ...
   * @requires Authentication
   */
  async observation_user_updates(params?: ObservationUserUpdatesParams): Promise<AxiosResponse<any>> {
    return this.client.get(`/observations/updates`, { params });
  }
   ...
   * @requires Authentication
   */
  async observation_field_value_update(id: number): Promise<AxiosResponse<any>> {
    return this.client.put(`/observations/${id}/viewed_updates`);
  }
}